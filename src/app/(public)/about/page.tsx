...
export const metadata: Metadata = {
  ...
  description:
    "Graphite Energy Inc. is the exclusive sales agent of Etablissements Gallois S.A., a major Madagascar natural flake graphite operation active since 1901.",
};
    ...
    <div className="bg-background text-foreground">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-base sm:text-lg">
          ...
          — a major Madagascar natural flake graphite operation active since
          1901, with more than 120 years of production history.
        </p>
      </section>
