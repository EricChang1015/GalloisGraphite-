...
| 30 | **Dashboard 多語系**（2026-05-27）：next-intl + cookie `mg-locale` + `profiles.locale`（migration 028）；`(app)/**` 儀表板 UI 支援 `en` / `zh-CN`；Settings 語言選擇器；合約正文 / email / SMS / 公開頁 / admin 仍英文 | `src/i18n/*` + [`I18N_PLAN.md`](./I18N_PLAN.md) |
...
- **公開行銷頁 / admin 後台多語系**（儀表板 `en` + `zh-CN` 已完成；見 §2.1 #30）
